                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customer.update', $customer->id) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control @error('Phonenumber') is-invalid @enderror"
                                        id="Phonenumber" name="Phonenumber" value="{{ $customer->Phonenumber }}"
                                        required>
                                    <span class="invalid-feedback" role="alert">
                                        @error('Phonenumber')
                                        <strong>{{ $message }}</strong>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="DoorNo" name="DoorNo"
                                        value="{{ $addressParts[0] ?? '' }}" placeholder="Door No" required>
                                </div>
                                <div class="col">
                                    <label for="Street">Street</label>
                                    <input type="text" class="form-control" id="Street" name="Street"
                                        value="{{ $addressParts[1] ?? '' }}" placeholder="Street" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="City" name="City"
                                        value="{{ $addressParts[2] ?? '' }}" placeholder="City" required>
                                    <span class="invalid-feedback" role="alert">
                                        @error('City')
                                        <strong>{{ $message }}</strong>
                                        @enderror
                                ...
                                <div class="col">
                                    ...
                                    <input type="number" class="form-control" id="Pincode" name="Pincode"
                                        value="{{ $customer->Pincode }}" required>
                                    <span class="invalid-feedback" role="alert">
                                        @error('Pincode')
                                        <strong>{{ $message }}</strong>
                                        @enderror
                        ...
                        <div id="imagePreview" style="margin-top: 5px;">
                            ...
                            <span id="DeleteImageButton" onclick="toggleImageRemoval()"
